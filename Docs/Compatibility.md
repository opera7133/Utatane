...
| 偽さくら Rebirth 2.008 | ese-shiori + ParticleMakoto | 独自辞書の復号とese-shioriの主要な評価処理、ParticleMakotoをネイティブ実装。起動、定期会話、初回名前入力と選択肢、ダブルクリックメニュー、単語学習と再読込をテスト済み | ニュース取得、Neuron・Synapses学習グラフ、長時間の状態変化は未確認 |
